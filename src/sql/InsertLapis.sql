INSERT INTO Artifacts VALUES (1001, "Invisibility Potion", "Wanna know how it feels to be invisible? Try this potion and make your body invisible for 5 hours after drinking it. Just avoid getting wet. Don't drink too much, may cause some side-effects. Moderately safe so just handle with care and use it wisely. ", "Invisibility", "moderatelySafe", 600, "2019-10-09 00:00:01");
INSERT INTO Artifacts VALUES
(1002, "Hypnotic Mirror", "Just a look into this mirror can hypnotize the person. A second look into the mirror will neutralize the effect. Make sure to handle it with care because breaking it will bring bad luck! Can be dangerous if misused!", "Hypnotism", "dangerous", 750, "2019-07-25 00:00:01");
...
INSERT INTO Experiments VALUES(2224, "Mirror mirror, what do you recall?", "Using hypnotic mirror to obtain memories that are present in mind subconsciously. This time, no animal was used because the mirror has no effect on them. The tester had no idea that their day was controlled by the experimenter. Their routines were same but small changes were made which did not alert the tester. After using the mirror, the tester was able to collect all the little changes made that they did not recall prior to hypnotism.");
INSERT INTO Experiments VALUES(2225, "Getting the truth out of you.", "Its time to reveal the truth using truth perfume. This tool if it works, it will be the most useful tool. A piece of cake was left with the message saying Do not eat! The tester saw it and ate it. When prompted about it, they declined. Truth perfume was sprayed in the air and upon inhaling it, truth came out.");
